...
<body>
    ...
    <div class="container">
        <h2 class="text-center" id="titulo">Citas General</h2>
        <form action="insertar_gen.jsp" method="POST">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="medico" name="medico">
                  <option value="Dra. Ana Milena Isaza Narvaez" required>Dra. Ana Milena Isaza Narváez</option>
                  <option value="Dra. Alejandra Bustamante Nunez" required>Dra. Alejandra Bustamante Núñez</option>
                  <option value="Dra. Maria Carmenza Cuenca Arias" required>Dra. María Carmenza Cuenca Arias</option>
                  <option value="Dr. Fabio Andres Tandioy Delgado" required>Dr. Fabio Andrés Tandioy Delgado</option>
                  <option value="Dr. Dario Fuertes Bolaños" required>Dr. Darío Fuertes Bolaños</option>
                  <option value="Dr. Alberto Gonzalez" required>Dr. Alberto González</option>
                </select>
            </div>
            <div class="form-group">
