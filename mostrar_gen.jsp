...
<head>
    ...
    <title>Mis citas médico general</title>
    <style>
        body{
    ...
    <div class="container">
            ...
            <%
                        ...
                        try{
                            ...
                            String consultaSQL = "select * from general where doc_gen = '"+user+"';";
                            rs=sentencia.executeQuery(consultaSQL);

                            while(rs.next()){
                                String centro = rs.getString("centro_gen");
                                String medico = rs.getString("medico_gen");
                                String fecha = rs.getString("fecha_gen");
                                String hora = rs.getString("hora_gen");  %> 
                                <br>
                                
                                <div class="container d-flex justify-content-center">
                                    <div class="card bg-light text-dark d-flex justify-content-center" style="width:300px" >
                                        <img class="card-img-top" src="img/medical_appointment.png" alt="Card image" id="imagen" style="width:80px;margin-top: 10px;margin-left: 37%;">
